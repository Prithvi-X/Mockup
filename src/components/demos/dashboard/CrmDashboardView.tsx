    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4 shadow-sm">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3.5 py-2 rounded-md bg-violet-600 hover:bg-violet-700 text-white font-medium text-xs sm:text-sm shadow-sm transition"
        >
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-semibold text-gray-900">Visual Deal Pipeline</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          {stages.map((stage) => {
            ...
            return (
              <div
                key={stage}
                className="bg-gray-50 border border-gray-200 rounded-lg p-3.5 flex flex-col justify-between min-h-[420px]"
              >
                {/* Column Header */}
                <div>
                  <div className="flex items-center justify-between pb-2.5 border-b border-gray-200 mb-2.5">
                    <div className="flex items-center gap-1.5">
                      ...
                      <h4 className="font-semibold text-xs uppercase tracking-wider text-gray-800">
                        {stage}
                      </h4>
                    </div>
                    <span className="text-[11px] font-mono bg-white border border-gray-200 px-2 py-0.5 rounded text-gray-600">
                      {leadsInStage.length}
                    </span>
                  </div>

                  <div className="text-[11px] text-gray-500 mb-2.5 font-mono">
                  ...
                  <div className="space-y-2.5">
                    {leadsInStage.map((lead) => {
                      ...
                      return (
                        <div
                          key={lead.id}
                          className="bg-white border border-gray-200 rounded-md p-3 space-y-2 shadow-sm hover:border-gray-300 transition"
                        >
                          ...
                          <div className="flex items-center justify-between pt-1.5 border-t border-gray-100 text-xs">
                            <span className="text-[11px] text-gray-500">{lead.contactPerson}</span>
                          ...
                          <div className="flex items-center justify-between pt-1">
                            {prev ? (
                              <button
                                ...
                                className="p-1 px-1.5 rounded bg-gray-100 hover:bg-gray-200 text-gray-600 text-[10px] font-medium flex items-center gap-0.5 transition"
                            ...
                            {next && (
                              <button
                                ...
                                className="p-1 px-2 rounded bg-violet-600 hover:bg-violet-700 text-white font-medium text-[10px] flex items-center gap-0.5 shadow-sm transition"
